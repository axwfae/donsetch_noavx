...
# 下载 noavx 预编译包及其校验文件（以 v4.2.5_sync 为例，请用 Releases 页最新版）
TAG=v4.2.5_sync
...
donsetch tools     # 应输出 4 个工具 schema: web_fetch / web_search / web_crawl / web_screenshot
```
...
预期：返回 `serverInfo: donsetch 4.2.5`、4 个工具、调用返回结构化内容。
